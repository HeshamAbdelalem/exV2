...
@Component({
	selector: 'app-sellcurrencyouts',
	templateUrl: './SellCurrencyOuts.component.html',
	styleUrls: ['./SellCurrencyOuts.component.scss'],
...
export class SellCurrencyOutsComponent implements OnInit {

	public displayedColumns = ['RowNo', 'DocumentDate', 'DocumentCode', 'CurrencyID', 'Amount', 'Total', 'SenderAccountID', 'ReceiverAccountID', 'ReceiverName', 'Links'];
	...
	Display() {
		...
		_CurrencyTransfer.XObjectTypeID = XObjectTypeEnum.SellCurrencyOut;
