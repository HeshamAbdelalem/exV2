...
@Component({
	selector: 'app-CashBuyCurrencies',
	templateUrl: './CashBuyCurrencies.component.html',
	styleUrls: ['./CashBuyCurrencies.component.scss'],
	providers: [
		DatePipe,
...
export class CashBuyCurrenciesComponent implements OnInit {

	public displayedColumns = ['RowNo', 'DocumentDate', 'DocumentCode', 'DocumentNo', 'CurrencyID', 'Amount', 'Total', 'Buyer', 'Links'];
	...
	Display() {
		...
		_BuyCurreny.XObjectTypeID = XObjectTypeEnum.CashBuyCurrency;
