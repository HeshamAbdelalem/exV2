...
@Component({
	selector: 'app-sellcurrencytocustomers',
	templateUrl: './SellCurrencyToCustomers.component.html',
	styleUrls: ['./SellCurrencyToCustomers.component.scss'],
...
export class SellCurrencyToCustomersComponent implements OnInit {

	public displayedColumns = ['RowNo', 'DocumentNo', 'DocumentDate', 'DocumentCode', 'CurrencyID', 'Amount', 'Total', 'ReceiverAccountID', 'Links'];
	...
	Display() {
		...
		_CurrencyTransfer.XObjectTypeID = XObjectTypeEnum.SellCurrencyToCustomer;
