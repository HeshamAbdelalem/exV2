...
@Component({
	selector: 'app-sellcurrencytocustomer',
	templateUrl: './SellCurrencyToCustomer.component.html',
	styleUrls: ['./SellCurrencyToCustomer.component.scss'],
...
export class SellCurrencyToCustomerComponent implements OnInit {
	...
	Save() {
		if (this.myForm.valid) {
			...
			this.CurrencyTransfer.XObjectTypeID = XObjectTypeEnum.SellCurrencyToCustomer;
