...
export class CityService extends ApiService {
  ...
  public City_Auto(trem?: string): Observable<any> {
    this.autoComplete = new AutoComplete();
    this.autoComplete.Table = 'City_Vw';
  ...
  public GetCityPage(obj: City): Observable<ResultViewModel> {
    return this.GetPage(obj);
  }

  public GetCityPage_Old(sortColumn: string, sortDir: string, pageIndex: number): Observable<any> {
  ...
  public AddCity(obj: City): Observable<ResultViewModel> {
    return this.Add(obj);
  }

  public UpdateCity(obj: City): Observable<ResultViewModel> {
    return this.Update(obj);
  }

  public DeleteCity(id: number): Observable<ResultViewModel> {
